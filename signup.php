...
<body class>
    ...
    <main>
        <hr>
        <h2>Sign up as JavaJam Member!</h2>
        <p>Please fill in this form to create an account. Required information is marked with an asterisk (*)</p>
        <form action="processSignup.php" method="POST">
          <div class="mb-3">
              <input type="text" class="form-control" placeholder="*Name" aria-label="Name" name="uname" required>
          </div>
          ...
          <div class="mb-3">
              <input type="password" class="form-control" placeholder="*Password" aria-label="Password1" name="password" required>
          </div>

          <div class="mb-3">
              <input type="password" class="form-control" placeholder="*Reenter password" aria-label="Password2" name="rpassword" required>
          </div>
